...
class DatabaseHelper {
  ...
  Future<List<Map<String, dynamic>>> getAllStudents() async {
    ...
    final result = await db.rawQuery('''
    SELECT students.nis, students.student_name, students.spp_paid, 
           payments.payment_amount AS total_paid, payments.payment_date
    FROM students
  ...
  Future<void> registerStudent(
    ...
    // Generate VA number
    final vaNumber = await generateVaNumber(nis); // Make sure this function is implemented
    ...
    print('Student registered with NIS: $nis, VA Number: $vaNumber, Amount Due: $initialAmountDue');
  }


  Future<void> registerStaff(String email, String password, String nip, String name) async {
    final db = await database;
    try {
